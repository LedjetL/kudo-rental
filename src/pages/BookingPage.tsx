...
export default function BookingPage() {
  ...
  const [form, setForm] = useState<BookingForm>(() => {
    ...
    return {
      ...
      pickupLocation: ss.getItem('kudo_pickup_location') || ss.getItem('kudo_location') || LOCATIONS[0],
      dropoffLocation: ss.getItem('kudo_dropoff_location') || ss.getItem('kudo_location') || LOCATIONS[0],
      selectedExtras: [],
      firstName: '',
      lastName: '',
      email: '',
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 clamp(16px, 4vw, 40px) 80px' }} className="booking-content">
        ...
        {step === 'done' && (
          <div style={{ textAlign: 'center', maxWidth: '560px', margin: '0 auto', paddingTop: '40px' }}>
            ...
            {/* Icon — green tick if email ok, warning if failed */}
            <div style={{
              width: '80px', height: '80px',
              borderRadius: '50%',
              background: sendError === 'email_failed' ? 'rgba(255,165,0,0.1)' : 'rgba(192,57,43,0.1)',
              border: `1px solid ${sendError === 'email_failed' ? 'rgba(255,165,0,0.4)' : 'rgba(192,57,43,0.3)'}`,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              margin: '0 auto 32px',
              fontSize: '32px',
            }}>
            ...
            <h2 style={{
              ...
              {sendError === 'email_failed' ? 'Booking Received' : 'Booking Confirmed!'}
            </h2>

            <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '14px', color: '#888', marginBottom: '24px', lineHeight: 1.7 }}>
              {sendError === 'email_failed'
                ? 'We received your booking but the confirmation email could not be sent. Please send us your reference on WhatsApp to complete your booking.'
            ...
            {sendError === 'email_failed' && (
              <div style={{
                ...
                marginBottom: '24px',
                fontFamily: "'Montserrat', sans-serif",
                fontSize: '12px', color: '#ffaa00', lineHeight: 1.7,
              }}>
                ⚠️ Email delivery failed — your booking is <strong>not confirmed</strong> until you message us on WhatsApp below.
              </div>
            )}
            ...
            <div style={{
              ...
              <p style={{
                ...
                color: '#c0392b', letterSpacing: '4px',
              }}>
                {bookingRef}
              </p>
            </div>
            ...
            <div style={{
              ...
              {[
                { label: 'Vehicle', value: `${car.name} ${car.year}${car.color ? ` · ${car.color}` : ''}` },
            ...
            {sendError === 'email_failed' ? (
              ...
              >
                <WAIcon fill="#fff" /> Complete Booking on WhatsApp
              </a>
            ) : (
              <>
                ...
                <a
                  ...
                  style={{
                    ...
                    padding: '14px 32px',
                    border: '1px solid #25D366', borderRadius: '2px',
                    color: '#25D366',
                    fontFamily: "'Montserrat', sans-serif",
...
function WAIcon({ fill = '#25D366' }: { fill?: string }) {
  return (
