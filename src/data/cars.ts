...
export const cars: Car[] = [
  ...
  },
  {
    ...
    transmission: 'Automatic',
    fuel: 'Diesel',
    features: ['Air Conditioning', 'Bluetooth', 'USB Charging', 'Panoramic Roof'],
  ...
  },
  {
    ...
    transmission: 'Automatic',
    fuel: 'Diesel',
    features: ['Leather Seats', 'Cruise Control', 'Navigation', 'Quattro', 'Heated Seats'],
  ...
  },
  {
    ...
    transmission: 'Automatic',
    fuel: 'Diesel',
    features: ['7 Seats', '4x4', 'Air Conditioning', 'Panoramic Roof', 'Navigation', 'Roof Rails'],
